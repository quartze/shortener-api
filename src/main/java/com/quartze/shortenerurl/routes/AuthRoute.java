...
public class AuthRoute {
    ...
    public ResponseEntity<Auth> refreshAccount(@RequestHeader("refresh") String token) {
    ...
    public ResponseEntity<User> getMeInfo(@Parameter(hidden = true) @RequestHeader("authorization") String token) {
        if (token == null) throw new TokenIsInvalidException();
        token = token.replace("Bearer ", "");
